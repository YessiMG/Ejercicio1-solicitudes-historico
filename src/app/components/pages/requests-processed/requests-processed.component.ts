...
@Component({
  selector: 'app-requests-processed',
  templateUrl: './requests-processed.component.html',
  styleUrls: ['./requests-processed.component.scss']
})
export class RequestsProcessedComponent implements OnInit {
  ...
  private getColumnsTable(){
    if(this.typeCompany == "empresa1"){
      this.displayedColumns = ['registrationNumber', 'documentType', 'documentNumber', 'customerName', 'businessType', 'requestDate', 'approvalDate'];
    }
    else if(this.typeCompany == "empresa2"){
      this.displayedColumns = ['documentType', 'documentNumber', 'customerName', 'requestNumber', 'registrationNumber', 'requestDate', 'approvalDate', 'businessType'];
    }
  }
